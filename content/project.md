...
date: '2025-08-19'
draft: false
title: 'Projekt: Víceosý kytarový pedál'
---
...
**Cíl:** Dostat zvuk z kytary do mikrokontroléru, zpracovat ho a poslat ven.
...
{{< figure src="/images/Zapojeni.jpg" caption="Breadboard prototyp" >}}
...
{{< figure src="/images/Teensy.jpg" caption="Teensy s Audio Shieldem" >}}
...
1. Přímé připojení na potenciometry.
2. Mechanický převod na klasický malý joystick.
3. Magnetické měření pomocí Hallových senzorů. 
